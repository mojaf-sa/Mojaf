    ...
    <div className="f-footer-container">
      <footer className="f-footer">
        <div className="f-container">
          ...
          {/* === Popular Guides (SEO internal links) – appears on every page === */}
          <div style={{
            marginTop: "24px",
            padding: "16px",
            background: "#f7f7f7",
            ...
            <h3 style={{margin:"0 0 12px"}}>Popular Guides (SPC • Skirting • Fasteners)</h3>
            <ul style={{
              listStyle:"none",
              padding:0,
              margin:0,
              ...
              {/* SPC flooring – Riyadh/Jeddah/Dammam */}
              <li><a href="/blog/riyadh-spc-flooring-supplier.html">SPC flooring supplier — Riyadh</a></li>
              <li><a href="/blog/jeddah-spc-flooring-supplier.html">SPC flooring supplier — Jeddah</a></li>
              <li><a href="/blog/dammam-spc-flooring-supplier.html">SPC flooring supplier — Dammam</a></li>

              {/* Skirting – Riyadh/Jeddah/Dammam */}
              <li><a href="/blog/riyadh-wall-skirting-supplier.html">Wall skirting supplier — Riyadh</a></li>
              <li><a href="/blog/jeddah-wall-skirting-supplier.html">Wall skirting supplier — Jeddah</a></li>
              <li><a href="/blog/dammam-wall-skirting-supplier.html">Wall skirting supplier — Dammam</a></li>

              {/* Screws/Fasteners – Riyadh/Jeddah/Dammam */}
              <li><a href="/blog/riyadh-screws-fasteners-supplier.html">Screws & fasteners — Riyadh</a></li>
              <li><a href="/blog/jeddah-screws-fasteners-supplier.html">Screws & fasteners — Jeddah</a></li>
              <li><a href="/blog/dammam-screws-fasteners-supplier.html">Fasteners — Dammam</a></li>
            </ul>
          </div>
