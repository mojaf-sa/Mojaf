 ...
 <section className="hero-section1">
          ...
          <div className="hero-content1">
            ...
            <div className="hero-subtitle-container1">
              ...
              <div className="hero-subtitle1">
                The complete solution for building materials
              </div>
            </div>
    ...
    <section class="features-section1">
        <div class="features-container1">
            <div class="feature1" data-aos="zoom-in-up" data-aos-delay="0">
                <div class="feature-icon1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                        ...
                        <polyline class="st0" points="22,22 22,29 16,26 10,29 10,22 "></polyline>
                        <line class="st0" x1="16" y1="9" x2="16" y2="10"></line>
                        <line class="st0" x1="16" y1="16" x2="16" y2="17"></line>
                        <path class="st0" d="M17,10h-1.5c-0.8,0-1.5,0.7-1.5,1.5v0c0,0.8,0.7,1.5,1.5,1.5h1c0.8,0,1.5,0.7,1.5,1.5v0c0,0.8-0.7,1.5-1.5,1.5 H15"></path>
                    </svg>
                </div>
                <h3 class="feature-title1">Affordable Pricing</h3>
                <p class="feature-description1">We offer competitive prices without compromising quality.</p>
            </div>
            
            <div class="feature1" data-aos="zoom-in-up" data-aos-delay="100">
                <div class="feature-icon1">
                ...
                <h3 class="feature-title1">Uncompromising Quality</h3>
                <p class="feature-description1">We are committed to providing only highest quality standards to our customers.</p>
            </div>
            
            <div class="feature1" data-aos="zoom-in-up" data-aos-delay="200">
                <div class="feature-icon1">
                ...
                <h3 class="feature-title1">Availability</h3>
                <p class="feature-description1">We ensure timely access to our products through a wide distribution network.</p>
            </div>
        </div>
    </section>
    </div>
