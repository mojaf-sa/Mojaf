    ...
    <div className="about-us-container e-con-full e-flex e-parent">
      <div className="text-content e-con-full e-flex e-child">
        <div className="heading-section">
          <h2 className="main-heading elementor-heading-title">About Us</h2>
          ...
          <p className="description">
            ...
            specializes in the distribution of all kinds of Steel, Timber, Insulation, Plumbing, Electrical, 
      ...
      <div className="image-content e-con-full e-flex e-child">
        <div className="main-image">
          <img className='img-1' src="/about-m.webp" alt="Construction Materials" />
        </div>
        <div className="overlay-image">
          <img className='img-2' src="/about2.webp" alt="Overlay" />
        </div>
      </div>
