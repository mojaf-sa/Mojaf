...
function AboutUs() {
  // --- JSON-LD Organization (entity + legal name + topical relevance) ---
  const orgJsonLd = {
    ...
    "description": "MOJAF is a trusted supplier of construction and building materials in Saudi Arabia, including fasteners, wall skirting, flooring, insulation, electrical components, and portacabin materials across Riyadh, Jeddah, Dammam, Khobar, Makkah, and Madinah.",
    "foundingDate": "2020",
    "address": {
      "@type": "PostalAddress",
      "addressCountry": "SA",
  ...
  return (
    <>
      <Helmet>
        ...
        />
        {/* Google ignores meta keywords; removed to avoid noise */}
        ...
        {/* Use the routed URL that users will see after BrowserRouter + 404.html fallback */}
        ...
        {/* Remove page-level canonical to prevent duplicate canonicals. Keep one in index.html */}
        {/* <link rel="canonical" href="https://www.mojaf-sa.com/about" /> */}

        {/* Organization / Entity JSON-LD */}
      ...
      <div className="about-us-container e-con-full e-flex e-parent">
        {/* (Kept) Your original page content, titles, sections */}
        <div className="text-content e-con-full e-flex e-child">
          ...
          {/* --- Legal Entity Section (visible, reinforces GBP verification) --- */}
          <section className="about-legal" aria-label="Legal Entity">
            ...
            <p>
              ...
              registered in the Kingdom of Saudi Arabia. While we are publicly known and branded as
              <strong> MOJAF Trading</strong>, this is the official name used in compliance and government records.
            </p>
          </section>
        </div>
        ...
        <style jsx>{`
          ...
          .counter-number { font-size: 28px; font-weight: 700; margin-bottom: 2px; }
          .counter-title { font-size: 16px; font-weight: 500; }

          .main-image { position: relative; z-index: 2; }
          .main-image img {
            width: 70%;
            max-height: 500px;
            height: auto;           /* avoid forced distortion */
            border-radius: 8px;
          ...
          @media (max-width: 992px) {
            ...
            .text-content { padding-right: 0; margin-bottom: 50px; }
            .image-content { margin-top: 50px; }
            .overlay-image { right: 0; bottom: -50px; }
          }

          @media (max-width: 768px) {
            .vision-mission-section { flex-direction: column; }
