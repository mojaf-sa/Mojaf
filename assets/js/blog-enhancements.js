(function () {
  ...
  const pageImages = main.querySelectorAll('img')
  const hasVisualContent = pageImages.length >= 2 || Boolean(main.querySelector('.image-grid, .category-grid, figure.hero, .gallery, .post-image'))

  if (!hasVisualContent && !document.querySelector('.blog-product-gallery')) {
